...
<div class="main-content-wrap sidenav-open d-flex flex-column">
    ...
    <div class="main-content">
        ...
        <div class="breadcrumb">
            ...
            <ul>
                <li><a href="javascript:void(0)"> Technologies Listing Dashboard</a></li>
            </ul>
        </div>
            --}}
            ...
            <div class="container-fluid site-width">
                ...
                <div class="row">
                    <div class="col-12 align-self-center">
                        <div class="sub-header py-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto pl-2"><span class="h4 my-auto">Technologies Listing</span></div>
                            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                                <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                                <li class="breadcrumb-item active"><a href="{{route('technology_index')}}">Technology</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        ...
                        <div class="pull-right text-right p-2">
                            <a class="btn btn-success" href="" data-toggle="modal" data-target="#AddModal" style="background: #28a745; border-color: #28a745;"> Create New Technology</a>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><img src="{{asset($technology->img)}}" style="width: 50px;height: 50px"></td>
                        <td>
                            <form action="{{ route('technology_destroy',$technology->id) }}" method="DELETE" class="form-delete">
                                <a class="btn btn-info showModalBtn" href="#" data-toggle="modal" data-showid="{!! $technology->id !!}">Show</a>
                                <a class="btn btn-primary editModalBtn" href="#" data-toggle="modal" data-id="{!! $technology->id !!}">Edit</a>
                                
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger delete_button" onclick="return confirm('Are you sure you want to delete this technology?');">Delete</button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
                ...
                <div class="row mt-3">
                    <div class="col-lg-6 offset-lg-6">
                     {{$technologys->links('pagination::bootstrap-4')}}
                    </div>
                </div>
                <!-- END: Card DATA-->
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background: #218838; color: #fff;">
                <h5 class="modal-title" id="exampleModalLongTitle">Add Technology</h5>
            ...
            <div class="modal-body">
                <div class="document-content">
                    ...
                    @endif
                    <form action="{{ route('technology_store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background: var(--info); color: #fff;">
                <h5 class="modal-title" id="exampleModalLongTitleshow">Show Technology</h5>
                <button type="button" class="close" style="color: #fff;" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                <strong>Image:</strong>
                                <br />
                                <img style="width:150px;height:150px" src="{{asset('images/no-img-avalible.png')}}" id="showImg" alt="technology" />
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background: #1e3d73; color: #fff;">
                <h5 class="modal-title" id="exampleModalLongTitle">Edit Technology</h5>
                <button type="button" class="close" style="color: #fff;" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="document-content">
                    ...
                    @endif
                    <form action="{{ route('technology_update') }}" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="user_id" value="{{Auth::user()->id}}" />
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <strong>Image:</strong>
                                <br />
                                <img  style="width:150px;height:150px" src="{{asset('images/no-img-avalible.png')}}" id="editImg" alt="technology" />
                                <input type="file" name="img" value="{{ old('img') }}" id="img" class="form-control mt-2 mb-2" />
                                <br />
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".showModalBtn").click(function () {
            ...
            var action = '{{route("technology_show")}}/' + id;
            var url = '{{route("technology_show")}}/' + id;
            $.ajax({
                type: "get",
                url: url,
                data: { id: id },
                success: function (data) {
                    ...
                    $("#showid").attr("action", '{{route("technology_show")}}/' + id);
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".editModalBtn").click(function () {
            var id = $(this).data("id");
            var action = '{{route("technology_edit")}}/' + id;
            var url = '{{route("technology_edit")}}/' + id;
            $.ajax({
                type: "get",
                url: url,
                data: { id: id },
