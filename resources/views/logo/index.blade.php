                    ...
                    <div class="col-12 align-self-center">
                        <div class="sub-header py-3 align-self-center d-sm-flex w-100 rounded">
                            ...
                            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('logo_index')}}">Logo</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('logo_update') }}" method="POST" enctype="multipart/form-data" id="form1" runat="server">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <!-- <div class="alert"></div> -->
                                <div id="img_container"><img id="editImg" style="width:250px;height:250px"  src="{{asset($logo->img)}}" alt="your image" title="" /></div>
